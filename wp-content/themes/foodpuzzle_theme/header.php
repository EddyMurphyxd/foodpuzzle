...
<head>
  ...
  <link rel="icon" href="/wp-content/themes/foodpuzzle_theme/img/favicon.ico" type="image/x-icon" />
...
<div id="wrapper">
  <header class="main-header">
    ...
    <nav class="main-navigation">
      ...
      <div class="container">
        <div id="logo-wrapper">
          <a href="<?php echo get_site_url(); ?>"><img src="/wp-content/themes/foodpuzzle_theme/img/logo.png" alt="" /></a>
        </div>
        <?php  
